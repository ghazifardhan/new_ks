    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/home') }}"><img src="http://www.keranjangsayur.com/img/logoks4.png" width="75%" heigh="75%" style="margin-top: -8px;"/></a>
            </div>
...
<script>
    ...
    function getDataVoucher(){
            $(".customerName").autocomplete({
                  source: 'http://keranjangsayur.com/invoice/new_ks/public/customerJson',
                  select: function(event, ui){
                    if(ui.item)
                    {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "http://keranjangsayur.com/invoice/new_ks/public/populatevoucher",

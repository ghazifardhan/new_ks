...
$objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('B'.$totalCash, $totaltest['cash'])
                ->setCellValue('A'.$totalTransfer, 'TOTAL TRANSFER')
                ->setCellValue('B'.$totalTransfer, $totaltest['bank_transfer'])
                ->setCellValue('A'.$totalCreditCard , 'TOTAL CREDIT CARD')
                ->setCellValue('B'.$totalCreditCard , $totaltest['credit_card'])
                ->setCellValue('A'.$grandTotal, 'GRAND TOTAL')
                ->setCellValue('B'.$grandTotal, $totaltest['cash'] + $totaltest['bank_transfer'] + $totaltest['credit_card']);

...
<page>
    ...
    <tr>
        ...
        <td class="fontSize"><?php echo $data[$x]['customer_address_1'];?></td>
    </tr>
    <tr>
        <td style="text-align:left;vertical-align:top;" class="bold"></td>
        <td style="text-align:left;vertical-align:top;" class="bold tdwidth2"></td>
        <td class="fontSize"><?php echo $data[$x]['customer_address_2'];?></td>
    </tr>
    <tr>
        <td style="text-align:left;vertical-align:top;" class="bold"></td>
        <td style="text-align:left;vertical-align:top;" class="bold tdwidth2"></td>
        <td style="font-weight: bold;" class="fontSize"><?php echo $data[$x]['customer_address_3'];?></td>
    </tr>
    <tr>
        <td rowspan="3" ><img src="https://s28.postimg.org/hqx3tgzjh/footerfixks.jpg" width="125" height="20" style="padding-left: 15px;"></td>
        <td colspan="2" style="text-align: center; font-weight: bold; color: red; font-size: 16;"><?php echo $data[$x]['description'];?></td>
    </tr>
    <tr>
        <td colspan="2" style="text-align: center; font-weight: bold; color: red; font-size: 16;"><?php echo $data[$x]['payment_method_name'];?></td>
    </tr>
    <tr>
        <td colspan="2" style="text-align: center; font-weight: bold; color: red; font-size: 16;"><?php echo $data[$x]['description_2'];?></td>
    </tr>
    <tr>

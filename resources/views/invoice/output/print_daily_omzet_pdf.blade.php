...
<body>
  ...
  <table border="1">
    ...
    <tr>
      ...
      <td class="resultPadding"><?php echo "IDR " . number_format($totaltest['cash'],0,',','.'); ?></td>
    </tr>
    <tr>
      <td class="resultPadding">TOTAL TRANSFER</td>
      <td class="resultPadding"><?php echo "IDR " . number_format($totaltest['bank_transfer'],0,',','.'); ?></td>
    </tr>
    <tr>
      <td class="resultPadding">TOTAL CREDIT CARD</td>
      <td class="resultPadding"><?php echo "IDR " . number_format($totaltest['credit_card'],0,',','.'); ?></td>
    </tr>
    <tr>
      <td class="resultPadding">GRAND TOTAL</td>
      <td class="resultPadding"><?php echo "IDR " . number_format($totaltest['cash'] + $totaltest['bank_transfer'] + $totaltest['credit_card'],0,',','.'); ?></td>
    </tr>
</body>
</html>
